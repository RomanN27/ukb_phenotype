...
from src.phenotypes.depression import general_depression
...
from src.phenotypes.insomnia import insomnia
from src.phenotypes.neuroticism import neuroticism